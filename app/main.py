...
main.py
--------
FastAPI backend for a RAG-based role-based access chatbot at ARTECH.
...
async def chat(request: Request):
    ...
    try:
        ...
        # -----------------------------
        # Role-based retrieval (ARTECH)
        # -----------------------------
        if "c-levelexecutives" in user_role:
            # Executives have broad access
            ...
            # Employees get only general category
        ...
        prompt = f"""
You are an AI assistant at ARTECH. The user has the role: {user['role']}.
